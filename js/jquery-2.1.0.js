!(function (e, t) {
          ...
          n.getById
            ...
            : (delete r.find.ID,
              (r.filter.ID = function (e) {
                ...
                return function (e) {
                  var n =
                    typeof e.getAttributeNode !== E && e.getAttributeNode("id");
                  return n && n.value === t;
                };
              })),
  ...
  (h.filter = function (e, t, n) {
    ...
    h.fn.extend({
      ...
      is: function (e) {
        return !!C(this, "string" == typeof e && b.test(e) ? h(e) : e || [], !1)
          .length;
      },
    });
  var N,
    ...
    if ("string" == typeof e) {
      ...
      if (n[1]) {
        if (
          ...
          h.merge(
            this,
            h.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : p, !0)
          ),
      ...
      closest: function (e, t) {
        for (
          var n,
            ...
            i = this.length,
            o = [],
            s = b.test(e) || "string" != typeof e ? h(e, t || this.context) : 0;
          i > r;
          r++
        )
      ...
      function (e, t) {
        h.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 && (D[e] || h.unique(i), E.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  var S,
    ...
    L = {};
  function q() {
    p.removeEventListener("DOMContentLoaded", q, !1),
      ...
      return (
        S ||
          ...
          "complete" === p.readyState
            ? setTimeout(h.ready)
            : (p.addEventListener("DOMContentLoaded", q, !1),
          ...
          if (
            ...
            for (n = s.length; n--; )
              0 === (r = s[n].name).indexOf("data-") &&
                ((r = h.camelCase(r.slice(5))), W(o, r, i[r]));
  ...
  (h.event = {
          ...
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            ...
            (s = v.handle) ||
              (s = v.handle = function (t) {
                return typeof h !== X && h.event.triggered !== t.type
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        3 !== r.nodeType &&
          8 !== r.nodeType &&
          !V.test(m + h.event.triggered) &&
          (m.indexOf(".") >= 0 &&
            ((v = m.split(".")), (m = v.shift()), v.sort()),
          (c = m.indexOf(":") < 0 && "on" + m),
          ((t = t[h.expando]
            ? t
            : new h.Event(m, "object" == typeof t && t)).isTrigger = i ? 2 : 3),
          (t.namespace = v.join(".")),
        ...
        if (!i && !d.noBubble && !h.isWindow(r)) {
          for (
            u = d.delegateType || m, V.test(u + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            g.push(s), (a = s);
        ...
        for (o = 0; (s = g[o++]) && !t.isPropagationStopped(); )
          (t.type = o > 1 ? u : d.bindType || m),
            (f = (F.get(s, "events") || {})[t.type] && F.get(s, "handle")) &&
              f.apply(s, n),
            (f = c && s[c]) &&
              f.apply &&
              h.acceptData(s) &&
    ...
    h.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function (
      e,
      t
    ) {
      h.event.special[e] = {
    ...
    h.fn.extend({
      ...
      remove: function (e, t) {
        for (
          ...
          t || 1 !== n.nodeType || h.cleanData(pe(n)),
            n.parentNode &&
              (t && h.contains(n.ownerDocument, n) && ce(pe(n, "script")),
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; r > n; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (h.cleanData(pe(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      domManip: function (e, t) {
        ...
        if (
          ...
          for (s = (o = h.map(pe(n, "script"), ue)).length; c > l; l++)
            (a = n),
              l !== d &&
                ((a = h.clone(a, !0, !0)), s && h.merge(o, pe(a, "script"))),
              t.call(this[l], a, l);
          if (s)
            for (
              u = o[o.length - 1].ownerDocument, h.map(o, le), l = 0;
              s > l;
              l++
            )
              (a = o[l]),
                re.test(a.type || "") &&
                  ...
                  (a.src
                    ...
                    : h.globalEval(a.textContent.replace(oe, "")));
        }
        return this;
      },
    }),
  ...
  function ve(e) {
    ...
    return (
      n ||
        (("none" !== (n = me(e, t)) && n) ||
          ((t = (he = (
            he || h("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function Le(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (s += h.css(e, n + B[o], !0, i)),
        r
          ? ("content" === n && (s -= h.css(e, "padding" + B[o], !0, i)),
            "margin" !== n && (s -= h.css(e, "border" + B[o] + "Width", !0, i)))
          : ((s += h.css(e, "padding" + B[o], !0, i)),
            "padding" !== n &&
              (s += h.css(e, "border" + B[o] + "Width", !0, i)));
    return s;
  }
  function qe(e, t, n) {
    var r = !0,
      ...
      (r = e[s]).style &&
        ...
        t
          ...
          : o[s] ||
            ((i = I(r)),
            ((n && "none" !== n) || !i) &&
              F.set(r, "olddisplay", i ? n : h.css(r, "display"))));
    for (s = 0; a > s; s++)
      (r = e[s]).style &&
  ...
  h.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          u = e.style;
        return (
          (t = h.cssProps[a] || (h.cssProps[a] = Se(u, a))),
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        a = h.camelCase(t);
      return (
        (t = h.cssProps[a] || (h.cssProps[a] = Se(e.style, a))),
        (s = h.cssHooks[t] || h.cssHooks[a]) &&
          "get" in s &&
          (i = s.get(e, !0, n)),
        void 0 === i && (i = we(e, t, r)),
    ...
    h.each(["height", "width"], function (e, t) {
      h.cssHooks[t] = {
        get: function (e, n, r) {
          return n
            ? 0 === e.offsetWidth && Ce.test(h.css(e, "display"))
              ? h.swap(e, Ee, function () {
                  return qe(e, t, r);
                })
              : qe(e, t, r)
            : void 0;
        ...
        set: function (e, n, r) {
          ...
          return Ae(
            ...
            n,
            r
              ? Le(e, t, r, "border-box" === h.css(e, "boxSizing", !1, i), i)
              : 0
          );
        },
      };
    ...
    (h.cssHooks.marginRight = Te(f.reliableMarginRight, function (e, t) {
      return t
        ? h.swap(e, { display: "inline-block" }, we, [e, "marginRight"])
        : void 0;
    })),
    ...
    $e = [
      function (e, t, n) {
        ...
        1 === e.nodeType &&
          ...
          "none" === (l = h.css(e, "display")) && (l = ve(e.nodeName)),
          "inline" === l &&
            "none" === h.css(e, "float") &&
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === X
            ...
            : ((1 === o && h.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r =
                  h.attrHooks[t] || (h.expr.match.bool.test(t) ? Ue : void 0))),
              void 0 === n
        ...
        : this.each(
            h.isFunction(e)
              ...
              : function () {
                  if ("string" === n)
                    for (
                      var t, r = 0, i = h(this), o = e.match(A) || [];
                      (t = o[r++]);
  ...
  e.ActiveXObject &&
    ...
    (f.cors = !!Tt && "withCredentials" in Tt),
    (f.ajax = Tt = !!Tt),
  ...
  h.ajaxSetup({
    ...
    h.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      return a || "jsonp" === t.dataTypes[0]
        ? ((i = t.jsonpCallback = h.isFunction(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          a
  ...
  (h.offset = {
    ...
    h.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (
      t,
      n
    ) {
      var r = "pageYOffset" === n;
    ...
    h.each(["top", "left"], function (e, t) {
      h.cssHooks[t] = Te(f.pixelPosition, function (e, n) {
        return n
          ? ((n = we(e, t)), xe.test(n) ? h(e).position()[t] + "px" : n)
          : void 0;
      });
    }),
    h.each({ Height: "height", Width: "width" }, function (e, t) {
      h.each({ padding: "inner" + e, content: t, "": "outer" + e }, function (
        n,
        r
      ) {
        h.fn[r] = function (r, i) {
